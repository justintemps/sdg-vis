							...
							<nav className="large-12-col" role="navigation">
								...
								<div className="collapse">
									<ul role="menu" className="nav navbar-nav" id="menu">
										...
										<li role="menuitem" className=""><a href="/global/about-the-ilo/lang--en/index.htm">Home</a></li>
										<li role="menuitem" className="here"><a href="/global/about-the-ilo/lang--en/index.htm">About the ILO</a></li>
										<li role="menuitem" className=""><a href="/global/about-the-ilo/newsroom/lang--en/index.htm">Newsroom</a></li>
