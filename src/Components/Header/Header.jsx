							...
							<nav className="large-12-col" role="navigation">
								...
								<div className="collapse">
									<ul role="menu" className="nav navbar-nav" id="menu">
										...
										<li role="menuitem" className="here"><a href="/global/meetings-and-events/lang--en/index.htm">Meetings and events</a></li>
										<li role="menuitem" className="here"><a href="/global/publications/lang--en/index.htm">Publications</a></li>
										<li role="menuitem" className="here"><a href="/global/research/lang--en/index.htm">Research</a></li>
										<li role="menuitem" className="here"><a href="/global/standards/lang--en/index.htm">Labour standards</a></li>
										<li role="menuitem" className="here"><a href="/global/statistics-and-databases/lang--en/index.htm">Statistics and databases</a></li>
										<li role="menuitem" className="here"><a href="/global/contact-us/lang--en/index.htm">Contact Us</a></li>
									</ul>
								</div>
							</nav>
						</div>
